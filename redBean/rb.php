...
class OODBBean implements\IteratorAggregate,\ArrayAccess,\Countable,Jsonable
{
	 ...
	 * What to do if a FUSE models method does not exist?
	 ...
	 * @param BeanHelper $beanhelper bean helper to obtain a toolbox and a models
	 *
	 * @return void
	 */
	...
	*/
	...
	public function __call( $method, $args )
	{
		...
		if ( !method_exists( $this->__info['models'], $method ) ) {
			...
			$message = "FUSE: method does not exist in models: $method";
...
abstract class Repository
{
	 ...
	 *
	 * @param OODBBean|SimpleModel $embeddedBean the bean or models
	 *
	 * @return integer
	 */
...
interface BeanHelper
{
	 ...
	 * If no models is returned (NULL), RedBeanPHP might ask again.
	 *
	 ...
	 * You *could* create a models depending on properties of the bean, but
	 ...
	 * $book = R::dispense('book');
	 * var_dump($book->box()); //NULL cant reach models
	 * $book->pages = 5;
	 * var_dump($book->box()); //Booklet
	 * $book->pages = 15;
	 * var_dump($book->box()); //still.. Booklet, models has been set
	 * $book2 = R::dispense('book');
	 * $book2->pages = 15;
	 * var_dump($book2->box()); //Book, more than 10 pages
	 * </code>
	 *
	 * @param OODBBean $bean bean to obtain the corresponding models of
	 *
...
class SimpleFacadeBeanHelper implements BeanHelper
{
	...
	/**
	 * Sets the factory function to create the models when using FUSE
	 * to connect a bean to a models.
	 *
